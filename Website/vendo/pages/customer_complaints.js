  ...
  const CustomerReview = () =>{
          ...
          return (
              <li>
                  <Card>
                      <Card.Body>
                          <Card.Title>  
                            <div className="pending-application-section-title">#V1243234</div>
                            <div className="pending-application-section-title">Kirti College ka vada pav</div>
                          </Card.Title>
    ...
    return (
      <div>
          ...
          <div className="approved-application-main-container" style={{height:"100vh"}}>
